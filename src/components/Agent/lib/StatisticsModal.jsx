...
import { AGENT_NAME, genLogger, LAMBDA_PREFIX } from "../../Connect/lib";
import { useInterval } from "../../Connect/hooks";
...
const buildUrl = (method) =>
  `https://${LAMBDA_PREFIX}.execute-api.ap-southeast-1.amazonaws.com/${method}`;
...
const getPieChartData = () =>
  fetch(
    `https://${LAMBDA_PREFIX}.execute-api.ap-southeast-1.amazonaws.com/getIntentsForAgent?agentName=${AGENT_NAME}`
  )
    .then((res) => res.json())
